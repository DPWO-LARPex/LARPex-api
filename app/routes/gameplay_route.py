...
from services.gameplay_service import get_gameplay_by_id, get_gameplay_milestones_by_game_id, get_gameplay_milestones_by_gameplay_id, get_gameplay_status_by_game_id
...
@router.get("/gameplay-milestones-by-gameplay-id/{gameplay_id}", response_model=GameplayMilestoneGetSchema)
